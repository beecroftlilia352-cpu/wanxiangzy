    ...
    extend: {
      colors: {
        ...
        codex: {
          ...
          ice: "var(--codex-ice)",
          dark: "var(--codex-dark)",
          "accent-06": "var(--codex-accent-06)",
          "accent-08": "var(--codex-accent-08)",
          "accent-10": "var(--codex-accent-10)",
          "accent-12": "var(--codex-accent-12)",
          "accent-14": "var(--codex-accent-14)",
          "accent-16": "var(--codex-accent-16)",
          "accent-18": "var(--codex-accent-18)",
          "accent-20": "var(--codex-accent-20)",
          "accent-22": "var(--codex-accent-22)",
          "accent-24": "var(--codex-accent-24)",
          "accent-25": "var(--codex-accent-25)",
          "accent-26": "var(--codex-accent-26)",
          "accent-28": "var(--codex-accent-28)",
          "accent-30": "var(--codex-accent-30)",
          "accent-34": "var(--codex-accent-34)",
          "accent-35": "var(--codex-accent-35)",
          "accent-38": "var(--codex-accent-38)",
          "accent-42": "var(--codex-accent-42)",
          "accent-45": "var(--codex-accent-45)",
          "accent-48": "var(--codex-accent-48)",
          "accent-55": "var(--codex-accent-55)",
        },
        brand: {
          50: "#eef4ff",
          100: "#dbe8ff",
