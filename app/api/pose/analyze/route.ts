...
export async function POST(request: NextRequest) {
  try {
    ...
    const textPrompt = `你是商业摄影和图像生成提示词工程师。请分析主图中的人物、服装、场景、光影和构图，把下面的姿势裂变提示词优化成可直接用于图像生成模型的中文提示词。
目标：生成一张四宫格图片，每格都是同一个人物、同一套服装、同一场景、同一光影和摄影质感，但人物姿势不同。
必须强化：人物脸部身份一致，发型一致，身材比例一致，服装版型/颜色/材质/图案/褶皱一致，背景透视和光影一致，真实摄影质感，避免AI味。
