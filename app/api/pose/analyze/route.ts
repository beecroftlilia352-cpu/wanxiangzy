...
export async function POST(request: NextRequest) {
  try {
    ...
    const textPrompt = `你是商业摄影和图像生成提示词工程师。请分析�?主图中的人物、服装、场景、光影和构图，把下面的姿势裂变提示词优化成可直接用于图像生成模型的中文提示词�?
目标：生成一张四宫格图片，每格都是同一个人物、同一套服装、同一场景、同一光影和摄影质感，但人物姿势不同�?
必须强化：人物脸部身份一致，发型一致，身材比例一致，服装版型/颜色/材质/图案/褶皱一致，背景透视和光影一致，真实摄影质感，避�?AI 味�?
可以给出四个明确姿势，例如：正面自然站立、侧身回头、手扶头发、轻微行走或转身�?
负面约束：不要改变人物身份，不要换衣服，不要改变场景，不要生成多余人物，不要扭曲手指和肢体，不要塑料皮肤，不要蜡像感，不要卡通感，不要过度磨皮�?
用户当前提示词：
${prompt || ""}

只输出最终提示词�?20-180字左右，不要解释。`;
