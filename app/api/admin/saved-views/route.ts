...
const RESOURCES = new Set(["users", "credits", "generations", "assets", "asset_lifecycle", "audit", "agent_evals", "prompt_experiments", "diagnostics", "reports", "risk_scores", "requests", "support_tickets", "moderation", "workers"]);
