...
export async function POST(request: NextRequest) {
  try {
    ...
    const moduleInstruction = moduleKind === "grass"
      ? "模块目标：服装种草图。图1服装/穿搭是唯一硬参考；如有图2，图2只作为场景、姿势、背景、构图、镜头距离、光线和种草氛围参考，不得复制图2服装，不得改变图1服装。"
      : "模块目标：模特换背景。图1是原始人物/服装/穿搭硬参考；只换背景时只替换图1背景，人物、脸、发型、服装、姿势和构图保持不变；换背景换模特时图2是模特参考、图3是背景参考；只换模特时图2只用于脸部参考；背景参考图只用于场景、光线、空间透视和构图氛围，不得改变图1服装。换背景类提示词必须保留自然融合约束：光线方向、色温、曝光、对比度、景深、镜头距离、地面透视、人物尺度、脚下接触阴影、边缘羽化和环境反光，避免白边、硬边、漂浮和贴纸感。";
...
3. 可以补强摄影语言、镜头语言、光线、构图、真实皮肤、真实面料、平台种草氛围；换背景类必须保留人物自然融入新环境的融合约束。
