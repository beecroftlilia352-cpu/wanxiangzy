...
export function InfiniteCanvas({ containerRef, viewport, backgroundMode = "lines", screenOverlay, onViewportChange, onCanvasMouseDown, onCanvasDeselect, onContextMenu, onDrop, children }: InfiniteCanvasProps) {
