...
function sameBatchMotion(prev?: CanvasNodeProps["batchMotion"], next?: CanvasNodeProps["batchMotion"]) {
    if (prev === next) return true;
    if (!prev || !next) return false;
    return prev.x === next.x && prev.y === next.y && prev.index === next.index;
}
...
export const CanvasNode = React.memo(CanvasNodeBase, areCanvasNodePropsEqual);
