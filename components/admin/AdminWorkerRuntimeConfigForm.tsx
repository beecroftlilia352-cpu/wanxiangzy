  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
        ...
        <NumberField label="单任务生图并发" value={config.imageBatchConcurrency} min={1} max={8} onChange={(value) => update("imageBatchConcurrency", value)} hint="全局上限；Standard 实际 2，VIP 实际 4" />
