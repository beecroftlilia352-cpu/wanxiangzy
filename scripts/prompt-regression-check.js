...
assertIncludes(multiTryOn, "Camera/framing/proportion lock", "多件镜头画幅锁定");
assertIncludes(multiTryOn, "Keep image 3's exact camera distance, lens perspective, crop rectangle, person scale", "多件镜头画幅锁定");
assertIncludes(multiTryOn, "do not zoom in, crop to half-body, crop off boots, enlarge the head", "多件头身比例锁定");
