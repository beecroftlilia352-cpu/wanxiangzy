...
assertIncludes(multiTryOn, "Fixed-canvas geometry: keep image 3's camera distance, crop, person scale, head-to-body ratio, floor line, and visible feet unchanged.", "多件镜头画幅锁定");
