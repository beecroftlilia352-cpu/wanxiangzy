...
export const GRASS_UPLOAD_RULE = {
  ...
  demos: [
    { title: "平铺图", description: "主体完整、服装清晰的平铺图", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/j9rQ7qVD/grass-demo-flat-1-ebc4675d04.png" },
    { title: "人台图", description: "人台展示图，适合迁移版型", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/5hRgQJzd/grass-demo-mannequin-701a21db50.jpg" },
    { title: "上身图", description: "真人上身图，适合保持穿搭关系", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/Qj6qJK7t/grass-demo-worn-1-7db098ec05.jpg" },
    { title: "平铺图", description: "单品主体完整、边缘清楚", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/d46hhSpV/grass-demo-flat-2-f4ced1bee6.jpg" },
    { title: "上身图", description: "自然上身图，适合种草场景", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/hJL4mRMd/grass-demo-worn-2-0ee3dc97a2.jpg" },
  ] satisfies GrassRuleDemo[],
  badExamples: [
    { title: "商品被遮挡", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/fdMjhgpX/pose-rule-bad-occluded-ae34483e1d.png" },
    { title: "图片不清晰", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/FbQqxjBv/garment-3d-rule-bad-blurry-58a6cb9ef9.png" },
    { title: "拍摄灯光暗", imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/WWKpW4Hf/grass-bad-dark-6497e069c3.png" },
  ],
} as const;
...
export const GRASS_TEMPLATES: GrassTemplate[] = [
  {
    ...
    name: "氛围美图",
    desc: "生活方式封面感，适合做首图",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/DgDJjMjm/grass-template-atmosphere-939274b5bb.png",
    prompt:
  ...
  },
  {
    ...
    name: "街道拍摄",
    desc: "城市街拍，自然出门感",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/hRfvVCJT/grass-template-street-0923eafda0.png",
    prompt:
  ...
  },
  {
    ...
    name: "对镜自拍",
    desc: "真实用户分享，保留穿搭完整",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/psR27Tz/grass-template-mirror-f65a95c3ac.png",
    prompt:
  ...
  },
  {
    ...
    name: "居家拍摄",
    desc: "松弛柔和，适合舒适单品",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/N6q4TN3f/grass-template-home-7a7bb48ff1.png",
    prompt:
  ...
  },
  {
    ...
    name: "电梯自拍",
    desc: "竖版全身，强种草内容感",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/LXX2bTJL/grass-template-elevator-e67dea3659.png",
    prompt:
  ...
  },
  {
    ...
    name: "试衣间自拍",
    desc: "真实试穿，细节清楚",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/BVx1nX9J/grass-template-fitting-9b2035e45e.png",
    prompt:
  ...
  },
  {
    ...
    name: "咖啡店",
    desc: "温暖松弛，小红书常用场景",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/MkdRfRyM/grass-template-cafe-57b0186cf7.png",
    prompt:
  ...
  },
  {
    ...
    name: "富士滤镜",
    desc: "胶片感，柔和清透",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/svQGKQsk/grass-template-fuji-1e8f9b45b2.png",
    prompt:
  ...
  },
  {
    ...
    name: "佳能人像",
    desc: "商业人像，画质清晰",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/sdMVRCsK/grass-template-canon-2feaa41a21.png",
    prompt:
  ...
  },
  {
    ...
    name: "帽子遮脸",
    desc: "氛围穿搭，弱化脸部",
    imageUrl: "https://vasthk.oss-cn-hongkong.aliyuncs.com/site-assets/original/remote/i.ibb.co/67ZffwGp/grass-template-hat-e6cd2c3908.png",
    prompt:
