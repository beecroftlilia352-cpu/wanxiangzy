...
export const MODELS: { value: LingyaModel; label: string; desc: string; badge?: string; icon: string }[] = [
  ...
  { value: "nano-banana-2", label: "Nano-Banana-2", desc: "最高4K", badge: "省积分", icon: "https://vastweargen-images.oss-cn-hongkong.aliyuncs.com/site-assets/original/model-icons/gemini.png" },
];
