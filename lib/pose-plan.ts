...
export const COMMERCIAL_POSE_EXPRESSION_PRESETS: CommercialPoseExpressionPreset[] = [
  {
    id: "natural-camera",
    label: "自然看镜头",
    text: "自然看向镜头，唇角轻微上扬，表情放松可信",
    angles: ["front", "detail"],
  },
  {
    id: "soft-smile",
    label: "轻微微笑",
    text: "轻微微笑，眼神稳定，保持商业模特的干净亲和感",
    angles: ["front", "side", "detail"],
  },
  {
    id: "calm-premium",
    label: "平静高级感",
    text: "表情平静克制，眼神有精神但不冷硬，避免证件照感",
    angles: ["front", "side", "detail"],
  },
  {
    id: "side-gaze",
    label: "自然侧视",
    text: "视线轻微偏离镜头，头颈跟随身体方向，表情自然松弛",
    angles: ["side", "front"],
  },
  {
    id: "soft-confident",
    label: "自信轻抬眼",
    text: "眼神自信但不锐利，头部保持自然高度，表情干净有精神",
    angles: ["front", "side", "detail"],
  },
  {
    id: "warm-commercial",
    label: "亲和商业感",
    text: "表情亲和，唇角轻轻上扬，眼神稳定，适合电商主图气质",
    angles: ["front", "detail"],
  },
  {
    id: "cool-editorial",
    label: "冷静大片感",
    text: "表情冷静克制，视线稳定或轻微偏离镜头，保持高级时装感",
    angles: ["front", "side", "detail"],
  },
  {
    id: "down-soft",
    label: "自然垂眸",
    text: "视线轻轻向下或看向手部动作，表情放松，不做刻意摆拍",
    angles: ["front", "side", "detail"],
  },
  {
    id: "detail-down-gaze",
    label: "看向细节",
    text: "视线自然落向手部或服装细节，表情专注但不刻意摆拍",
    angles: ["detail", "side"],
  },
  {
    id: "back-profile",
    label: "侧后轮廓",
    text: "头部跟随身体自然侧转，只保留侧脸轮廓或不露脸，不做夸张回眸",
    angles: ["back"],
  },
  {
    id: "back-away",
    label: "背面不露脸",
    text: "头颈跟随背面方向，不看镜头，重点保留肩背和后片结构",
    angles: ["back"],
  },
];
